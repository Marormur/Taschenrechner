...
namespace Taschenrechner.Annotations
{
    /// <summary>
    ...
    public sealed class ValueRangeAttribute : Attribute
    {
        ...
        public ValueRangeAttribute(long value) => this.From = this.To = value;

        public ValueRangeAttribute(ulong value) => this.From = this.To = value;
    ...
    public sealed class UriStringAttribute : Attribute
    {
        ...
        public UriStringAttribute(string httpVerb) => this.HttpVerb = httpVerb;
